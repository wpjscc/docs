...
use Wpjscc\Docs\Classes\Page;
use Wpjscc\Docs\Classes\PagesList;
...
class Index extends \Backend\Classes\Controller
{
    ...
    public function index()
    {
        ...
        if (empty($path)) {
            $this->pageTitle = Lang::get('wpjscc.docs::lang.titles.documentation');
            $this->vars['content'] = Lang::get('wpjscc.docs::lang.content.intro');
            ...
            $this->addJs([
                ...
                'id' => 'docs-content-js',
                'data-lang-copy-code' => Lang::get('wpjscc.docs::lang.buttons.copyCode'),
            ]);
    ...
    public function onUpdateDocs()
    {
        $updateSteps = [
            [
                ...
                'label' => Lang::get('wpjscc.docs::lang.updates.downloading'),
            ],
            [
                'code' => 'extractUpdates',
                'label' => Lang::get('wpjscc.docs::lang.updates.extracting'),
            ],
            [
                'code' => 'renderingDocs',
                'label' => Lang::get('wpjscc.docs::lang.updates.rendering'),
            ],
            [
                'code' => 'completeUpdate',
                'label' => Lang::get('wpjscc.docs::lang.updates.finalizing'),
            ],
        ];
    ...
    public function onExecuteStep()
    {
        ...
        switch ($stepCode) {
            ...
            case 'renderingDocs':
                ...
                break;
            case 'completeUpdate':
                Flash::success(Lang::get('wpjscc.docs::lang.updates.success'));
    ...
    protected function extractUpdates()
    {
        ...
        if (!Zip::extract($tempPath, $destFolder)) {
            throw new ApplicationException(Lang::get('wpjscc.docs::lang.updates.extractFailed', [
                'file' => $tempPath
            ]));
        }
